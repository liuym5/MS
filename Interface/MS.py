...
class Ui_MSForm(object):
    def setupUi(self, MSForm):
        ...
        self.RentalMnfstBtn.setGeometry(QtCore.QRect(150, 160, 61, 31))
        ...
        self.LWS952Btn.setGeometry(QtCore.QRect(150, 120, 61, 31))
        ...
        self.AKE952Btn = QtWidgets.QPushButton(MSForm)
        self.AKE952Btn.setGeometry(QtCore.QRect(10, 160, 61, 31))
        self.AKE952Btn.setObjectName("AKE952Btn")
        self.FlightBtn = QtWidgets.QPushButton(MSForm)
        self.FlightBtn.setGeometry(QtCore.QRect(80, 160, 61, 31))
        self.FlightBtn.setObjectName("FlightBtn")
    ...
    def retranslateUi(self, MSForm):
        ...
        self.AKE952Btn.setText(_translate("MSForm", "AKE952"))
        self.FlightBtn.setText(_translate("MSForm", "Flight"))
