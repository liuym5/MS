...
class Ui_MSForm(object):
    def setupUi(self, MSForm):
        ...
        self.DSMnfstBtn.setGeometry(QtCore.QRect(150, 160, 61, 31))
        ...
        self.SCM1Btn.setGeometry(QtCore.QRect(10, 160, 61, 31))
        self.SCM1Btn.setObjectName("SCM1Btn")
        self.SCM2Btn = QtWidgets.QPushButton(MSForm)
        self.SCM2Btn.setGeometry(QtCore.QRect(80, 160, 61, 31))
